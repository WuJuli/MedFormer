...
np.save('data_train_2017', Train_img)
np.save('data_test_2017', Test_img)
np.save('data_val_2017', Validation_img)

np.save('mask_train_2017', Train_mask)
np.save('mask_test_2017', Test_mask)
np.save('mask_val_2017', Validation_mask)
