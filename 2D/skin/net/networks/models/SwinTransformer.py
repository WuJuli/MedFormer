...
from net.layers import PatchEmbed, Mlp, DropPath, ClassifierHead, to_2tuple, to_ntuple, trunc_normal_, \
...
from .VisionTransformer import get_init_weights_vit
    ...
    def forward_features(self, x):
        ...
        for i in range(len(self.layers)):
            ...
            if i == len(self.layers) - 1:
                features.append((self.norm(x)).permute(0,3,1,2))
            else:
