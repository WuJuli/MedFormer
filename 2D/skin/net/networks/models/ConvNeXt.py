...
from net.layers import trunc_normal_, AvgPool2dSame, DropPath, Mlp, GlobalResponseNormMlp, \
    LayerNorm2d, LayerNorm, create_conv2d, get_act_layer, make_divisible, to_ntuple
from net.layers import NormMlpClassifierHead, ClassifierHead
    ...
    def forward_features(self, x):
        ...
        for i in range(len(self.stages)):
            ...
            if i == len(self.stages) - 1:
                features.append(self.norm_pre(x))
            else:
                features.append(x)
