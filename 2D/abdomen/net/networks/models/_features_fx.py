...
from net.layers import Conv2dSame, ScaledStdConv2dSame, CondConv2d, StdConv2dSame
from net.layers.non_local_attn import BilinearAttnTransform
from net.layers.pool2d_same import MaxPool2dSame, AvgPool2dSame
from net.layers.norm_act import (
    BatchNormAct2d,
    SyncBatchNormAct,
...
try:
    from net.layers import InplaceAbn
